...
class DetailsScreenHLT extends StatelessWidget {
  const DetailsScreenHLT({
    Key key,
  }) : super(key: key);
...
var description2 = Container(
  ...
  child: Text(
    "Hada Labo’s new generation 5 interlocking Hyaluronic Acids (HA) hydrates skin from the surface to inner skin layers for significantly moist, refined and plumped up with smooth bounciness, and help skin absorb rest of skincare products even better. ",
