...
class DetailsScreenNS extends StatelessWidget {
  const DetailsScreenNS({
    Key key,
  }) : super(key: key);
...
var description = Container(
  ...
  child: Text(
    "Defy ageing with this newly formulated Nutox Advanced Serum Concentrate. Enhanced with Actigenic+ and 2x bird’s nest extract, this lightweight serum speeds up production of your skin’s natural collagen, elastin, and hyaluronic acid. Skin becomes firmer and smoother in just 7 days. ",
