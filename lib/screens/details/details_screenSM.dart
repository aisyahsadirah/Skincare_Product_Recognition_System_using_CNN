...
class DetailsScreenSM extends StatelessWidget {
  const DetailsScreenSM({
    Key key,
  }) : super(key: key);
...
var description2 = Container(
  ...
  child: Text(
    "Simple Kind to Skin Hydrating Light Moisturiser provides care with a light feel on skin, leaves skin feeling soft, smooth and perfectly hydrated for up to 12 hours. Lightweight and fast-absorbing formulation that doesn’t clog pores, moisturizing your skin and keeping it pure and fresh. ",
